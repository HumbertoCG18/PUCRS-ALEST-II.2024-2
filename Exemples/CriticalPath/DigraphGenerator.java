...
import static CriticalPath.StdRandom.uniform;
import static CriticalPath.StdRandom.shuffle;
...
public class DigraphGenerator {
    ...
    public static Digraph simple(int V, int E) {
        ...
        while (G.E() < E) {
            int v = uniform(V);  // Agora você pode usar 'uniform' diretamente
            int w = uniform(V);  // Mesma coisa aqui
            Edge e = new Edge(v, w);
   ...
   /**
    ...
    public static Digraph dag(int V, int E) {
        ...
        for (int i = 0; i < V; i++)
            vertices[i] = i;
        shuffle(vertices);  // Agora o shuffle também pode ser chamado diretamente
        while (G.E() < E) {
            int v = uniform(V);
            int w = uniform(V);
            Edge e = new Edge(v, w);
